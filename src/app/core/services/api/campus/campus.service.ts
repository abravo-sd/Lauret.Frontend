...
export class CampusService {
  ...
  getAllCampus(filters: TablePaginatorSearch): Observable<ResponseV1<PageResultV1<CampusDTOV1[]>>> {
    return this.http.get<ResponseV1<PageResultV1<CampusDTOV1[]>>>(environment.api.concat('/CatCampus/GetAll'), {
      params: {
